...
const translations = {
  ...
  th: {
    nav: {
      ...
      serviceGroups: {
        ...
        group2: {
          ...
          items: [
            { name: "การวางแผนธุรกิจแบบบูรณา���าร (IBP)", href: "/service/integrated-business-planning" },
    ...
    summary: {
      title: "สรุป",
      description: "การวางแผนการผลิตภายใน Salesforce Manufacturing Cloud ประสานกิจกรรมการผลิตกับความต้องการของลูกค้าและข้อตกลงการขายเพื่อให้การดำเนินการผลิตมีประสิทธิภาพ โซลูชั่นเช่น Rootstock Cloud ERP ให้การจัดการใบสั่งงานที่ครอบคลุม การควบคุมพื้นโรงงาน และความสามารถในการจัดตารางการผลิตบนแพ��ตฟอร์ม Salesforce โดยกำเนิด ระบบรวมการพยากรณ์การขายและคำสั่งซื้อจร��งเพื่อสร้างแผนการผลิต ทำให้การจัดซื้อวัสดุเป็นอัตโนมัติ ติดตามความคืบหน้าการผลิตแบบเรียลไทม์ และให้การมองเห็นทั่วทั้งกระบวนการผลิตตั้งแต่วัตถุดิบจนถึงสินค้าสำเร็จรูป",
    },
    bestFor: {
      title: "เหมาะสำหรับ",
      items: [
    ...
    detailsSection: {
      ...
      paragraph2:
        "ด้วยการจัดการใบสั่งงานที่ครอบคลุมและการควบคุมพื้นโรงงาน โซลูชั่นการวางแ���นการผลิตช่วยให้ผู้ผ���ิตติดตามทุกแง่มุมของการผลิตแบบเรียลไทม์ ตั้งแต่การจัดสรรทรัพยากรและการวางแผนกำลังการผลิตไปจนถึงการติดตามความคืบห��้าและการควบคุมคุณภาพ ร������บให้การมองเห็นที่สมบูรณ์ในการดำเนินงานการผลิต ด้วยการซิงโครไนซ์การผลิตกับความต้องการจริงและการทำให้การวางแผนวัสดุเป็นอัตโนมัติ ผู้ผลิตสามารถลดต้นทุน ปรับปรุงประสิทธิภาพ และส่งมอบผลิตภัณฑ์ตรงเวลาในขณะที่รักษาระดับสินค้าคงคลังที่เหมาะสม",
    },
    contact: {
      title: "ติดต่อเรา",
      phone: "02-1243295",
