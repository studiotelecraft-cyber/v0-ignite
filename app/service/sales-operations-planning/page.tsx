...
const translations = {
  ...
  th: {
    ...
    detailsSection: {
      paragraph1:
        "การวางแผนการขายและการดำเนินงานแปลงวิธีการที่องค์กรจัดเรียงความต้องการกับอุปทานโดยการสร้างกรอบความร่วมมือที่เชื่อมต่อการขาย การดำเนินงาน การเงิน และการตลาด วงจร S&OP รายเดือนนำทีมข้ามสายงานมารวมกันเพื่อทบทวนกา��พยากรณ์ ประเมินกำลังการผลิต และตัดสินใจเชิงกลยุทธ์เกี่ยวกับการจัดสรรทรัพยากร ด้วยการรวมข้อมูลการขาย Salesforce กับระบบห่วงโซ่อุปทาน องค์กรสร้างแหล่งความจ��ิงเดียวที่เปิดใช้งานการตัดสินใจที่ขับเคลื่อนด้วยข้อมูล",
      paragraph2:
