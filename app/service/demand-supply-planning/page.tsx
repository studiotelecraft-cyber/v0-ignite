...
const translations = {
  ...
  th: {
    ...
    detailsSection: {
      ...
      paragraph2:
        "ด้วยความสามารถเช่น Materials Requirements Planning และ Distribution Requirements Planning โซลูชั่นการวางแผนอุปสงค์และอุปทานช่วยให้องค์กรสามารถสมดุลอุปสงค์และอุปทานในหลายตำแหน่งและสายผลิตภัณฑ์ การจับคู่อุปสงค์-อุปทานแบบเรียลไทม์ช่วยให้ผู้ผลิตและผู้จัดจำหน่ายตอบสนองต่อการเปลี่ยนแปลงได้อย่างรวดเร็ว ลดต้นทุนการขนส่ง และปรับปรุงระดับการบริการ ด้วยการเชื่อมต่อสัญญาณความต้อง���ารจาก Salesforce กับการดำเนินการห่วงโซ่อุปทาน โซลูชั่นเหล่านี้เปิดใช้งานการมองเห็นและควบคุมห่วงโซ่อุปทานแบบครบวงจร",
    },
    contact: {
      title: "ติดต่อเรา",
      phone: "02-1243295",
