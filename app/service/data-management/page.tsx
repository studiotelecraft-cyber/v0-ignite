...
const translations = {
  ...
  th: {
    ...
    details: {
      ...
      p3: "ส่วนที่ดีที่สุด? ระบบการจัดการข้อมูลช่วยกำจัดการแยกข้อมูล (data silos) และรับประกันความสอดคล้องของข้อมูลทั่วท��้งองค์กร เครื่องมือวิเคราะห์และการแสดงผลแบบอินเทอร์แอคทีฟช่วยระบุแนวโน้ม คาดการณ์ผล และทำการตัดสินใจบนฐานข้อมูลที่ขับเคลื่อนการเติบโตทางธุรกิจและข้อได้เปรียบทางก��รแข่งขัน",
    },
    contact: {
      title: "ติดต่อเรา",
      phone: "02-1243295",
