...
const translations = {
  ...
  th: {
    ...
    hero: {
      title: "Data Management",
      subtitle: "พลิกโฉมข้อมูลของคุณให้เป็นข้อมูลเชิงลึกที่นำมาใช้ได้จริงด้วย ปลดล็อกพลังของข้อมูล (Data Management) ของคุณท���่มีอยู่ให้เต็มศักยภาพ ชื่อข้อมูลให้เป็นระเบียบ ชื่อข้อมูลให้เป็นระเบียบ และค้นหาศักยภาพสูงสุดของข้อมูลธุรกิจของคุณในที่เดียว",
      cta: "นัดปรึกษา",
    },
    benefits: {
    ...
    details: {
      ...
      p3: "ส่วนที่ดีที่สุด? ระบบการจัดการข้อมูลช่วยกำจัดการแยกข้อมูล (data silos) และรับประกันความ��อดคล้องของข้อมูลทั่ว����้งองค์กร เครื่องมือวิเคราะห์และการแสดงผลแบบอินเทอร์แอคทีฟช่วยระบุแนวโน้ม คาดการณ์ผล และทำการตัดสินใจบนฐานข้อมูลที่ขับเคลื่อนการเติบโตทางธุรกิจและข้อได้เปรียบทางก��รแข่งขัน",
    },
    contact: {
      title: "ติดต่อเรา",
      phone: "02-1243295",
