...
export default function CustomerServicesCentrePage() {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      {/* Hero Section */}
      <section className="relative pt-32 pb-32 px-6 overflow-hidden bg-linear-to-br from-slate-900 via-purple-900 to-slate-800">
        ...
        <div className="container mx-auto relative z-10">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div className="space-y-10">
              <div className="inline-flex items-center gap-3 bg-linear-to-r from-purple-500/30 to-pink-500/30 backdrop-blur-md px-6 py-3 rounded-full border border-purple-400/40 shadow-xl shadow-purple-500/20">
              ...
              <div className="space-y-6">
                ...
                <div className="h-2 w-40 bg-linear-to-r from-purple-400 via-pink-400 to-purple-400 rounded-full" />
              </div>
              <p className="text-2xl md:text-3xl text-purple-100 leading-relaxed max-w-2xl font-light">{t.hero.subtitle}</p>
              <div className="flex flex-wrap gap-4">
                <Button onClick={scrollToContact} size="lg" className="bg-linear-to-r from-purple-500 to-pink-600 hover:from-purple-600 hover:to-pink-700 text-white rounded-full px-10 py-7 shadow-2xl shadow-purple-500/40 text-xl font-bold">
