      ...
      <article className="py-16 px-6">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-lg max-w-none">
            ...
            <p>
              สำหรับการประมวลผลข้อมูลส่วนบุคคลของลูกค้าของบริษัท ให้รวมถึงการประมวลผลข้อมูลส่วนบุคคลของของกรรม��ารผู้มีอำนาจลงนาม และ/หรือตัวแทนผู้ได้รับมอบหมาย หรือมอบอำนาจจากลูกค้าในการติดต่อประสานงานกับบริษัท หรือพนักงานอื่นใดที่มีส่วนเกี่ยวข้องในการใช้บริการของบริษัท โดยลูกค้าดังกล่าว
            </p>
            ...
            <h2>การเปิดเผยหรือส่งต่อข้อม���ลส่วนบุคคลของลูกค้า</h2>
            <p>โดยหลักการ��้อมูลส่วนบุคคลของลูกค้าจะไม่ถูกเปิดเผยออกไปให้แก่ บุคคลภายนอก แต่ในกรณีที่จำเป็น บริษัทอาจต้องเปิดเผ���และ/หรือส่งต่อข้อมูลส่วนบุคคลของลูกค้าให้แก่บุคคลภายนอก ดังนี้</p>
            <ol>
