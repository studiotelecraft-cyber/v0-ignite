      ...
      <article className="py-16 px-6">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-lg max-w-none">
            ...
            <p>โดยหลักการ��้อมูลส่วนบุคคลของลูกค้าจะไม่ถูกเปิดเผยออกไปให้แก่ บุคคลภายนอก แต่ในกรณีที่จำเป็น บริษัทอาจต้องเปิดเผยและ/หรือส่งต่อข้อมูลส่วนบุคคลของลูกค้าให้แก่บุคคลภายนอก ดังนี้</p>
            <ol>
