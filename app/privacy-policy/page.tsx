      ...
      <article className="py-16 px-6">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-lg max-w-none">
            ...
            <p>
              บริษัทประกาศนโยบายนี้เพื่อแจ้งลูกค้า ("ลูกค้า") ถึงเงื่อนไขเกี่ยวกับการเก็บรวบรวม ใช้ และเปิดเผยข้อมูลส่วนบุคคลที่บริษัทจำเป็นต้องดำเนินการ
            </p>
            ...
            <ol>
              <li>ก���รติดต่อสื่อสารเพื่อให้ข้อมูลที่ลูกค้าอาจร้องขอ หรือติดต่อเพื่อขอรับจากบริษัท</li>
            ...
            <p>
              บริษัทมีความจำเป็นในการเก็บรักษาข้อมูลส่วนบุคคลของลูกค้า เป็นระยะเวลาเท่าที่จำเป็นเพื่อวัตถุประสงค์ซึ่งได้ระบุไว้ในนโยบายฉบับนี้ ทั้งนี้ บริษัทจะอ้างอิงหลักเกณฑ์ที่ใช้กำหนดระยะเวลาเก็บ ดังนี้ (ก) บริษัทจะเก็บรักษาข้อมูลส่วนบุคคลของลูกค้าไว้ตลอดระยะเวลาที่บริษัทยังมีความสัมพันธ์กับ��ูกค้า และ (ข) อาจเก็บต่อไปตามระยะเวลาที่จำเป็นเพื่อการปฏิบัติตามกฎหมายหรือตามอายุความทางกฎหมาย
            </p>
